...
def perfArtemisWhynot():
    ...
    axwnq2=dfwnq2[['Query','DG(wo/ EXPL)','DG(w/ EXPL)']].plot.bar(width=0.7, color=['#00389F','#F43B00','#008000'])

    legend = axwnq2.legend(bbox_to_anchor=(-0.025, 1.036),prop={'size': 20},labels=['Query','DG(wo/ EXPL)','DG(w/ EXPL)'],loc=2,
    ...
    # ax2.xaxis.labelpad = 12
    ax2.set_xlim(0, 60)
    ax2.set_xticklabels(['1.9K','17.9K','171K','3.8M'],fontsize=24)
...
def perfSingleDerWhynot():
    ...
    # axwnq2=dfwnq2[['100','1000','10000','FULL']].plot.bar(width=0.9)
    axwnq2=dfwnq2[['Query','DG(wo/ EXPL)','DG(w/ EXPL)']].plot.bar(width=0.7, color=['#E7D501','#F43B00','#008000'])
